...
import { Bars3Icon, SunIcon, MoonIcon, ArrowLeftOnRectangleIcon } from './Icons';
...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="bg-gray-900/50 backdrop-blur-sm sticky top-0 z-40 border-b border-slate-800">
        ...
        <div className="flex items-center gap-4">
          ...
          {currentUser && (
            <div className="relative" ref={menuRef}>
              ...
              {isUserMenuOpen && (
                <div className="absolute left-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-md shadow-lg py-1 animate-fade-in-up">
