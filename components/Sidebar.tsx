...
export const SECTIONS = [
  ...
  { id: 'voiceToCode', label: 'صوت إلى كود', desc: 'بناء وتطوير التطبيقات البرمجية بالأوامر والوصف الصوتي مباشرة', Icon: MicrophoneIcon, color: 'text-rose-400', bg: 'bg-rose-500/10' },
  { id: 'videoToCode', label: 'فيديو إلى كود', desc: 'رفع أو تسجيل فيديو لتصميم واجهة تفاعلية وتحليله للبرمجة', Icon: VideoIcon, color: 'text-amber-400', bg: 'bg-amber-500/10' },
  ...
  { id: 'flowDemo', label: 'تجربة التدفق', desc: 'بناء وتجربة فعلية متكاملة لمسارات المستخدم وتدفق حركة التطبيقات', Icon: RocketLaunchIcon, color: 'text-orange-500', bg: 'bg-orange-500/10' },
  ...
  { id: 'preview', label: 'المعاينة والتحقق', desc: 'بيئة تشغيل وإنتاج حقيقية ومباشرة لمراجعة المشروع وتفاعلاته بدقة', Icon: ShieldCheckIcon, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
  ...
  { id: 'professionalTemplateGenerator', label: 'قالب إلى كود', desc: 'رفع أو توليد قوالب مخصصة من جهازك وتحويلها إلى أكواد ومعاينة حية', Icon: TemplateIcon, color: 'text-violet-400', bg: 'bg-violet-500/10' },
